    ...
    try {
        ...
        try {
            ...
            if (chat) {
                ...
                if (!('antilinkgc' in chat)) chat.antilinkgc = false // Tambahkan ini
                if (!('antilinkch' in chat)) chat.antilinkch = false // Tambahkan ini
                ...
                welcome: false,
                blacklist: [],
                antilinkgc: false, // Tambahkan ini
                antilinkch: false, // Tambahkan ini
                tagsw: {
                    delete: false,
                    kick: false
                },
